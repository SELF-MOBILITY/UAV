...
void AP_Vehicle::update_pso_cost(float cost, uint8_t type)
{
	...
	if(1==type)
	{
		fp=fopen("cost_TECS_Thr.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open cost_TECS_Thr.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}
	...
	{
		fp=fopen("cost_TECS_Pitch.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open cost_TECS_Pitch.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}
	...
	{
		fp=fopen("cost_Roll.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open cost_Roll.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}
	...
	{
		fp=fopen("cost_Pitch.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open cost_Pitch.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}
	...
	{
		fp=fopen("cost_Yaw.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open cost_Yaw.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}
	...
	{
		fp=fopen("input_energy.txt","w+");
		if(!fp)
		{
			printf("update_pso_cost open input_energy.txt error!\n");
			fclose(fp);
			exit(-1);
		}
	}

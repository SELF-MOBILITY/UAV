...
//	printf("1wwwwwwwwwwwwwwwwwwwwwwww  wind x= %f,y= %f,z= %f,len= %f,\n",wind_ef.x, wind_ef.y,wind_ef.z,wind_ef.length());
...
//	printf("1wwwwwwwwwwwwwwwwwwwwwwww  airspeed = %f\n",airspeed);
...
void Aircraft::update_wind(const struct sitl_input &input)
{
    ...
    wind_ef = Vector3f(cosf(radians(input.wind.direction))*cosf(radians(input.wind.dir_z)), 
                       ...
                       sinf(radians(input.wind.dir_z))) * 0;//input.wind.speed 1
...
//printf("1wwwwwwwwwwwwwwwwwwwwwwww  wind direction= %f,turbulence= %f,dir_z= %f,speed= %f,\n",input.wind.direction, input.wind.turbulence,input.wind.dir_z,input.wind.speed);
    ...
    if (wind_turb > 0 && !on_ground()) {
		...
		printf("wangkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk\n");
